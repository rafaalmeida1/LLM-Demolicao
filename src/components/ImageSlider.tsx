...
export function ImageSlider(){
    ...
    const titleImageSectionOpacity = useTransform(scrollYProgress, [0.510, 0.715], [0, 1]);
    const titleImageSectionX = useTransform(scrollYProgress, [0.510, 0.715], [-40, 0]);

    const hrImageSectionOpacity = useTransform(scrollYProgress, [0.510, 0.715], [0, 1]);

    const imageScrollOpacity = useTransform(scrollYProgress, [0.510, 0.730], [0, 1]);
