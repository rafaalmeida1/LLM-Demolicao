        ...
        <form onSubmit={handleSubmitContact} action="https://app.us18.list-manage.com/subscribe/post?u=77607056527c427bdce6ecf42&amp;id=bff1a8cb0b"
            ...
            <div className="flex flex-col relative">
                <div className="flex flex-col gap-3">
                    <header className="flex justify-between h-[4rem]">
                        <RocketLaunch size={40} className="animate-pulse text-green-600" weight="duotone" />
                        <X
                    ...
                    <input id="name" type="text" name="NAME" className="flex-1 text-gray-900 border-2 border-gray-100 rounded-lg p-2 mt-[2rem]" placeholder="Nome" required />
                ...
                <button
                    type="submit"
                    name="subscribe"
                    className="mt-[2rem] bg-gradient-to-r from-green-600 to-green-700 p-3 rounded-lg
